  ...
  //Material del Cristal (NaI con impurezas de Tl)
   ...
   G4Material* Sci_NaI_Tl = new G4Material (nameCris="Compuesto_NaI(Tl)", density, ncomponents=2 );
    ...
    G4ExtendedMaterial* Crystal =
        new G4ExtendedMaterial("crystal.material", Sci_NaI_Tl);
   ...
   //imprima Material
    ...
    G4EmLowEParameters* DeParam = new G4EmLowEParameters();
    
    DeParam->SetDeexActiveRegion("Crystal_logic", true,
                                 false, false);
    
    DeParam->SetDeexActiveRegion("Crystal_logic2", true,
                                 false, false);
    
    //........FIn Seleccion de geomtria para la desexitacion.......
